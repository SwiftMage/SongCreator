...
function GeneratingSongPage() {
  ...
  const openShareModal = (platform: string) => {
    const baseText = platform === 'tiktok' ? 
      `🎶 Just made a custom song with Song Mint & it's fire! 🔥 
...
#SongMint #CustomSong #AIMusic #PersonalAnthem #OriginalMusic #SongwriterVibes #MadeWithAI #TikTokMadeMe` :
      `🎶 I just made a custom song using Song Mint — and it SLAPS.
Written with my stories, my vibe, my people.
Check it out 🔥👇
