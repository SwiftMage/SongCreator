...
// Map plan IDs to Stripe price IDs (you'll need to get these from your Stripe dashboard)
const SUBSCRIPTION_PRICES: Record<string, string> = {
  'lite': process.env.STRIPE_LITE_PRICE_ID!,     // e.g., 'price_xxxxx'
  'plus': process.env.STRIPE_PLUS_PRICE_ID!,     // e.g., 'price_xxxxx'  
  'pro-monthly': process.env.STRIPE_MAX_PRICE_ID!, // e.g., 'price_xxxxx'
};
